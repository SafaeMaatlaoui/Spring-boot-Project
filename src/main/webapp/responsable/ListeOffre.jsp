                          ...
                          <table class="table table-striped">
                                                      ...
                                                      <c:forEach var="b" items="${Offre}">
                                                          <tr>
                                                              ...
                                                              <td>${b.getFournisseur()}</td>
                                                              <td>${b.getEtat()}</td>
                                                              <td>
                                                                  <form method="post" action="Offreaction">
                                                                      <input type="hidden" name="id" value="${b.getOffre_id()}">
                                                                      <c:if test="${b.getStatus()==0}">
                                                                          <button type="submit" name="action" value="Affecter" class="btn btn-info">Affecter</button>
                                                                      </c:if>
                                                                      <c:if test="${b.getStatus()==1}">
                                                                          <button type="submit" name="action" value="recu" class="btn btn-success">Recu</button>
                                                                      </c:if>
                                                                  </form>
                                                              </td>
                                                          </tr>
