                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="code" class="form-control" id="exampleInputUsername1" value="${constat.getId()}"  readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Objet :</label>
                                        <input type="text" name="code" class="form-control" id="exampleInputUsername1" value="${constat.getObjet()}" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Email :</label>
                                        <input type="text" name="date" class="form-control" id="exampleInputEmail1" value="${constat.getEmail()}" readonly>
                                    </div>
                                </form>
                                <c:if test="${result < 0}">
                                ...
                                <c:if test="${result > 0}">
                                    <form method="post" action="garantie">
                                        <input type="hidden" name="id" value="${constat.getId() }">
                                        <button type="submit" name="action" value="delete" class="btn btn-primary mr-2"> Changer Ressource </button>
                                    </form>
                                </c:if>
                            </div>
                        </div>
