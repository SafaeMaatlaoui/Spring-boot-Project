            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Information du Imprimante</h4>
                                ...
                                <form class="forms-sample" method="post" action="AddImprimente">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Vitesse</label>
                                        <input type="text" name="speed" class="form-control" id="exampleInputPassword1" placeholder="Vitesse" required>
                                    </div>
