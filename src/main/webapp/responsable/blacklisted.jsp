    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <!-- partial -->
                    <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <form method="POST" action="Blacklisted">
                                <div class="form-group">
                                    <label for="exampleTextarea1">Message De Motif</label>
                                    <textarea name="msg" class="form-control" id="exampleTextarea1" rows="4"></textarea>
                                </div>
